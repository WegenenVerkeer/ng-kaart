...
export const totaalOpTeHalen: Lazy<FilterTotaal> = () => ({
...
export const isTeVeelData: Refinement<FilterTotaal, TeVeelData> = (
  filterTotaal
): filterTotaal is TeVeelData => filterTotaal.kind === "TeVeelData";
export const isTotaalOpTeHalen: Refinement<FilterTotaal, TotaalOpTeHalen> = (
  filterTotaal
): filterTotaal is TotaalOpTeHalen => filterTotaal.kind === "TotaalOpTeHalen";
export const isTotaalOpgehaald: Refinement<FilterTotaal, TotaalOpgehaald> = (
  filterTotaal
): filterTotaal is TotaalOpgehaald => filterTotaal.kind === "TotaalOpgehaald";
...
export const isTotaalMislukt: Refinement<FilterTotaal, TotaalOphalenMislukt> = (
  filterTotaal
): filterTotaal is TotaalOphalenMislukt =>
  filterTotaal.kind === "TotaalOphalenMislukt";
