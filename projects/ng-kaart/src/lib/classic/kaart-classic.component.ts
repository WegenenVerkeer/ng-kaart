...
import { ZetKaartBevragenOptiesCmd } from "../kaart/kaart-bevragen/kaart-bevragen-opties";
...
export class KaartClassicComponent extends KaartComponentBase implements OnInit, OnDestroy, OnChanges, KaartCmdDispatcher<TypedRecord> {
  ...
  ngOnChanges(changes: SimpleChanges) {
    ...
    forChangedValue(
      ...
      onderdruk => this.dispatch(ZetKaartBevragenOptiesCmd({ kaartBevragenOnderdrukt: onderdruk })),
