...
export function validateAsStaticStyle(encoding: string, definitieText: string): Validation<AwvV0StaticStyle> {
...
function interpretJsonAsSpec(json: Object): Validation<AwvV0StaticStyle> {
  return chain(oi.field("version", oi.str)(json), version => {
    switch (version) {
      case Version:
        return oi.field("definition", AwvV0StaticStyleInterpreters.jsonAwvV0Definition)(json);
      default:
...
export const validateAwvV0StaticStyle: Validator<AwvV0StaticStyle, ol.style.Style> = jsonAwvV0Style;

export const serialiseAwvV0StaticStyle: Function1<AwvV0StaticStyle, string> = style =>
