...
export type Subscriber<Msg extends KaartMsg> = (
...
export type ValidationWrapper<T, Msg extends KaartMsg> = Wrapper<
  KaartCmdValidation<T>,
  Msg
>;
export type BareValidationWrapper<Msg extends KaartMsg> = ValidationWrapper<
  undefined,
  Msg
>;
