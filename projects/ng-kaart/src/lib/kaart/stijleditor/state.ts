...
export type LaagstijlaanpassingState =
  | LaagstijlAanpassend
...
export const GeenLaagstijlaanpassing: GeenLaagstijlaanpassing = {
  type: "geenAanpassing",
};
...
export const isAanpassingBezig: Refinement<
  ...
  LaagstijlAanpassend
> = (state): state is LaagstijlAanpassend => state.type === "aanpassingBezig";
export const isAanpassingNietBezig: Refinement<
  LaagstijlaanpassingState,
  LaagstijlAanpassend
> = (state): state is LaagstijlAanpassend => state.type === "geenAanpassing";
