...
export namespace OptiesOpUiElement {
  ...
  export const getOption = <A extends object>(uiSelector: string) => (
    optiesMap: OptiesOpUiElement
  ): option.Option<A> => option.fromNullable(optiesMap.get(uiSelector) as A);

  export const set = <A extends object>(a: A) => (uiSelector: string) => (
    optiesMap: OptiesOpUiElement
  ): OptiesOpUiElement => maps.set(optiesMap, uiSelector, a);
  ...
  export const init = <A extends object>(a: A) => (uiSelector: string) => (
    optiesMap: OptiesOpUiElement
  ): OptiesOpUiElement =>
  ...
  export const extend = <A extends object>(a: A) => (uiSelector: string) => (
    optiesMap: OptiesOpUiElement
  ): OptiesOpUiElement =>
