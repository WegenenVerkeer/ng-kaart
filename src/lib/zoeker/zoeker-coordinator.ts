...
import { Zoeker, ZoekerMetPrioriteiten, ZoekInput, ZoekResultaat, ZoekResultaten } from "./zoeker";

// export class ZoekerCoordinatorr {
//   private zoekersMetPrioriteiten: Array<ZoekerMetPrioriteiten> = Array();
...
//     return this.zoekersMetPrioriteiten.some(zmp => zmp.zoeker.naam() === naam);
//   }

//   isMinstens1ZoekerGeregistreerd(): boolean {
//     return this.zoekersMetPrioriteiten.length > 0;
//   }

//   verwijderZoeker(naam: string) {
//     this.zoekersMetPrioriteiten = this.zoekersMetPrioriteiten.filter(zmp => zmp.zoeker.naam() !== naam);
//   }

//   voegZoekerToe(zoekerMetPrioriteiten: ZoekerMetPrioriteiten) {
//     this.zoekersMetPrioriteiten = this.zoekersMetPrioriteiten.concat(zoekerMetPrioriteiten);
//   }
...
//     return this.zoekersMetPrioriteiten
//       .filter(zmp => zoekerNamen.contains(zmp.zoeker.naam())) //
//       .map(zmp => zmp.zoeker);
//   }

//   zoekersEnPrioriteiten(): ZoekerMetPrioriteiten[] {
//     return array.copy(this.zoekersMetPrioriteiten);
//   }
// }
